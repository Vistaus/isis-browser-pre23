...
enyo.kind({
	...
	components: [
		{name: "bookmarksService", kind: "DbService", dbKind: "com.junoavalon.isisprebrowserbookmarks:1", reCallWatches: true, method: "find", onSuccess: "gotBookmarksData", subscribe: true, onWatch:"refreshList"},
